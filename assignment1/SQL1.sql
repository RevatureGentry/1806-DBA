...
FAX, EMAIL) VALUES (9, 'Smith', 'Alex', 'IT Staff', 
'6',(TO_DATE('30-NOV-88', 'dd-mm-yy')), (TO_DATE('12-NOV-02', 
'dd-mm-yy')), '1234 6th St', 'Calgary', 'AB', 'Canada', 'T5D 6T1', '+1 
(780) 267-7856', '+1 (780) 267-7888', 'alex@chinookcorp.com');
INSERT INTO employee (EMPLOYEEID, LASTNAME, FIRSTNAME, TITLE, REPORTSTO, 
BIRTHDATE, HIREDATE, ADDRESS, CITY, STATE, COUNTRY, POSTALCODE, PHONE, 
FAX, EMAIL) VALUES (10, 'Simmons', 'Ben', 'IT Staff', 
'6',(TO_DATE('20-JUL-96', 'dd-mm-yy')), (TO_DATE('23-JAN-03', 
'dd-mm-yy')), '2525 25th St', 'Calgary', 'AB', 'Canada', 'T6S 7H4', '+1 
(780) 432-7118', '+1 (780) 432-7176', 'ben@chinookcorp.com');
INSERT INTO employee (EMPLOYEEID, LASTNAME, FIRSTNAME, TITLE, REPORTSTO, 
BIRTHDATE, HIREDATE, ADDRESS, CITY, STATE, COUNTRY, POSTALCODE, PHONE, 
FAX, EMAIL) VALUES (11, 'Embiid', 'Joel', 'IT Staff', 
'6',(TO_DATE('16-MAR-94', 'dd-mm-yy')), (TO_DATE('11-DEC-02', 
'dd-mm-yy')), '2121 21st St', 'Edmonton', 'AB', 'Canada', 'T2E 1J5', '+1 
(403) 648-8352', '+1 (403) 648-8390', 'joel@chinookcorp.com');
INSERT INTO employee (EMPLOYEEID, LASTNAME, FIRSTNAME, TITLE, REPORTSTO, 
BIRTHDATE, HIREDATE, ADDRESS, CITY, STATE, COUNTRY, POSTALCODE, PHONE, 
FAX, EMAIL) VALUES (12, 'Redick', 'JJ', 'IT Staff', 
'6',(TO_DATE('24-JUN-84', 'dd-mm-yy')), (TO_DATE('04-JUN-03', 
'dd-mm-yy')), '1717 17th St', 'Edmonton', 'AB', 'Canada', 'T1S 7J1', '+1 
(403) 845-8250', '+1 (403) 845-8288', 'jj@chinookcorp.com');
INSERT INTO employee (EMPLOYEEID, LASTNAME, FIRSTNAME, TITLE, REPORTSTO, 
BIRTHDATE, HIREDATE, ADDRESS, CITY, STATE, COUNTRY, POSTALCODE, PHONE, 
FAX, EMAIL) VALUES (13, 'Lebron', 'James', 'IT Staff', 
'6',(TO_DATE('30-DEC-84', 'dd-mm-yy')), (TO_DATE('09-APR-02', 
'dd-mm-yy')), '2323 23rd St', 'Calgary', 'AB', 'Canada', 'T2L 3J1', '+1 
(780) 431-3530', '+1 (780) 431-3500', 'lebron@chinookcorp.com');
...
VALUES (60, 'Carson', 'Wentz', 'null', '583 Lakeview Rd', 
'Philadelphia', 'PA', 'USA', '19148', '+1 (215) 424-5280', '(null)', 
'carson@yahoo.com', 4);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (61, 'Nick', 'Foles', 'null', '4309 Spring St', 'Philadelphia', 
'PA', 'USA', '19148', '+1 (215) 523-4032', '(null)', 'nick@gmail.com', 
3);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (62, 'Tom', 'Brady', 'null', '5555 Summer Lane', 'Boston', 'MA', 
'USA', '12389', '+1 (754) 743-9679', '(null)', 'tom@yahoo.com', 4);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (63, 'Matt', 'Ryan', 'null', '397 Darien St', 'Atlanta', 'GA', 
'USA', '17503', '+1 (538) 053-6267', '(null)', 'matt@gmail.com', 5);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (64, 'Cam', 'Newton', 'null', '6378 Wolf St', 'Charlotte', 'NC', 
'USA', '15795', '+1 (490) 745-2681', '(null)', 'cam@yahoo.com', 5);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (65, 'Russell', 'Wilson', 'null', '390 Broad Rd', 'Seattle', 
'WA', 'USA', '13405', '+1 (521) 513-8563', '(null)', 
'russell@gmail.com', 3);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (66, 'Aaron', 'Rodgers', 'null', '3481 Ritner Blvd', 'Green Bay', 
'WI', 'USA', '10937', '+1 (853) 520-8674', '(null)', 'aaron@yahoo.com', 
4);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (67, 'Drew', 'Brees', 'null', '249 2nd St', 'New Orleans', 'LA', 
'USA', '10258', '+1 (702) 532-5932', '(null)', 'drew@gmail.com', 5);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (68, 'Joe', 'Flacco', 'null', '1820 Aramingo Ave', 'Baltimore', 
'MD' , 'USA', '12538', '+1 (740) 515-7302', '(null)', 'joe@yahoo.com', 
5);
INSERT INTO customer (CUSTOMERID, FIRSTNAME, LASTNAME, COMPANY, ADDRESS, 
CITY, STATE, COUNTRY, POSTALCODE, PHONE, FAX, EMAIL, SUPPORTREPID) 
VALUES (69, 'Matthew', 'Stafford', 'null', '007 Jackson Blvd', 
'Detroit', 'MI', 'USA', '15253', '+1 (831) 525-9564', '(null)', 
'matt@gmail.com', 3);
...
INSERT INTO album (ALBUMID, TITLE, ARTISTID) VALUES (350, 'Illmatic', 
269);
...
-- Write a SQL Query that contains the albumId and number of songs in 
the album
DESC album;
...
SELECT invoice.total AS INVOICETOTAL, customer.firstname, 
customer.lastname, customer.country, customer.supportrepid
FROM customer
...
SELECT track.name, album.title, mediatype.name AS MediaType, genre.name 
AS Genre
FROM track
...
FROM
    ...
    WHERE invoice.invoicedate BETWEEN '01-JAN-13' AND '01-JAN-14'
    GROUP BY track.name
...
HAVING SUM(invoiceline.unitprice) = (SELECT MAX(sale)
    FROM(SELECT employee.employeeid, SUM(invoiceline.unitprice) sale
        FROM employee
        INNER JOIN customer ON employee.employeeid = 
...
-- Write a SQL Query that returns which albums have no Heavy Metal 
tracks
...
Brazilian customers
SELECT DISTINCT employee.firstname, employee.lastname AS manager
FROM employee manager
INNER JOIN employee ON employee.reportsto = manager.employeeid
INNER JOIN customer ON employee.employeeid = customer.supportrepid
...
each playlist
SELECT *
FROM (SELECT artist.name AS ARTISTNAME, playlist.name AS PLAYLISTNAME, 
...
SELECT *
FROM (SELECT track.name, invoiceline.unitprice * 
COUNT(invoiceline.trackid) AS GROSS, invoice.invoicedate
FROM track INNER JOIN invoiceline ON track.trackid = invoiceline.trackid
INNER JOIN invoice ON invoice.invoiceid = invoiceline.invoiceid
WHERE invoice.invoicedate BETWEEN '01-JAN-2009' AND '01-JAN-2010'
GROUP BY track.name, invoice.invoicedate, invoiceline.unitprice
ORDER BY GROSS DESC)
UNION ALL
SELECT *
FROM 
(SELECT track.name, invoiceline.unitprice * COUNT(invoiceline.trackid) 
AS GROSS, invoice.invoicedate
FROM track INNER JOIN invoiceline ON track.trackid = invoiceline.trackid
INNER JOIN invoice ON invoice.invoiceid = invoiceline.invoiceid
WHERE invoice.invoicedate BETWEEN '01-JAN-2010' AND '01-JAN-2011'
...
FROM track INNER JOIN invoiceline ON track.trackid = invoiceline.trackid
INNER JOIN invoice ON invoice.invoiceid = invoiceline.invoiceid
WHERE invoice.invoicedate BETWEEN '01-JAN-2011' AND '01-JAN-2012'
GROUP BY track.name, invoice.invoicedate
ORDER BY SUM(invoiceline.unitprice) DESC)
WHERE ROWNUM = 1
UNION ALL
...
FROM track INNER JOIN invoiceline ON track.trackid = invoiceline.trackid
INNER JOIN invoice ON invoice.invoiceid = invoiceline.invoiceid
WHERE invoice.invoicedate BETWEEN '01-JAN-2012' AND '01-JAN-2013'
GROUP BY track.name, invoice.invoicedate
ORDER BY SUM(invoiceline.unitprice) DESC)
WHERE ROWNUM = 1
UNION ALL
...
FROM track INNER JOIN invoiceline ON track.trackid = invoiceline.trackid
INNER JOIN invoice ON invoice.invoiceid = invoiceline.invoiceid
WHERE invoice.invoicedate BETWEEN '01-JAN-2013' AND '01-JAN-2014'
GROUP BY track.name, invoice.invoicedate
ORDER BY SUM(invoiceline.unitprice) DESC)
WHERE ROWNUM = 1;
--Not done

-- Write a SQL Query that determines the most downloaded genre by 
country
SELECT *
FROM                      
(SELECT genre.name, customer.country, COUNT(invoiceline.trackid)
FROM genre 
...
ORDER BY customer.country, COUNT(invoiceline.trackid) DESC)
--Not done
...
SELECT *
FROM 
(SELECT employee.firstname, employee.lastname, genre.name, 
COUNT(invoiceline.quantity) 
FROM employee
INNER JOIN customer ON employee.employeeid = customer.supportrepid
INNER JOIN invoice ON customer.customerid = invoice.customerid
INNER JOIN invoiceline ON invoice.invoiceid = invoiceline.INVOICEID
